export const POKEMON_GAME = {
  ...
  introducaoProjetoIngles:
    'Game developed in vanilla HTML, CSS and JavaScript using the GSAP libraries for animation and Howler for sound effects. The game map was created using Tiled.',
  introducaoProjetoEspanhol:
    'Juego desarrollado en HTML, CSS y JavaScript Vanilla utilizando las bibliotecas GSAP para animación y Howler para efectos de sonido. El mapa del juego fue creado utilizando Tiled.',
  introducaoProjetoPortugues:
    'Jogo desenvolvido em vanilla HTML, CSS e JavaScript utilizando as bibliotecas GSAP para animação e Howler para efeitos sonoros. O mapa do jogo foi criado usando Tiled.',
